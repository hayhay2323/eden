...
fn link_attribute_schema(attributes: &KnowledgeLinkAttributes) -> &'static str {
    match attributes {
        ...
        KnowledgeLinkAttributes::DescribesCurrentStateOf { .. } => "describes_current_state_of",
        KnowledgeLinkAttributes::SupportedByEvidence { .. } => "supported_by_evidence",
        KnowledgeLinkAttributes::ContradictedByEvidence { .. } => "contradicted_by_evidence",
        KnowledgeLinkAttributes::MissingExpectedEvidenceFor { .. } => {
            "missing_expected_evidence_for"
        }
        KnowledgeLinkAttributes::ExpectsConfirmationFrom { .. } => "expects_confirmation_from",
        KnowledgeLinkAttributes::AttentionAllocatedTo { .. } => "attention_allocated_to",
        KnowledgeLinkAttributes::UncertainDueTo { .. } => "uncertain_due_to",
