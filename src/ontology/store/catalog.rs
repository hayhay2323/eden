...
pub fn us_symbol_sector(symbol: &str) -> Option<&'static str> {
    match symbol {
        ...
        | "NXPI.US" | "MCHP.US" | "SWKS.US" | "MPWR.US" | "ARM.US" | "ASML.US" | "GFS.US"
        | "GRMN.US" | "COHR.US" | "QRVO.US" | "TER.US" | "LITE.US" => Some("semiconductor"),
        // ── China ADR ──
        ...
        // ── EV / Auto ──
        "TSLA.US" | "RIVN.US" | "LCID.US" | "GM.US" | "F.US" | "TM.US" | "STLA.US" | "APTV.US"
        | "CVNA.US" => Some("ev_auto"),
        // ── Finance / Insurance ──
        ...
        | "LPLA.US" | "APO.US" | "ARES.US" | "BX.US" | "BEN.US" | "BRO.US" | "CB.US" | "CFG.US"
        | "CINF.US" | "CPAY.US" | "EG.US" | "ERIE.US" | "FITB.US" | "GL.US" | "HBAN.US"
        | "HIG.US" | "IBKR.US" | "IVZ.US" | "KEY.US" | "KKR.US" | "L.US" | "MRSH.US" | "MTB.US"
        | "NTRS.US" | "PFG.US" | "PRU.US" | "RF.US" | "RJF.US" | "STT.US" | "SYF.US" | "WRB.US" => {
            Some("finance")
        }
        ...
        | "HCA.US" | "HUM.US" | "MCK.US" | "BDX.US" | "RMD.US" | "WST.US" | "ZBH.US" | "BAX.US"
        | "CAH.US" | "CNC.US" | "COR.US" | "CRL.US" | "DGX.US" | "DOC.US" | "DVA.US"
        | "GEHC.US" | "HOLX.US" | "HSIC.US" | "IEX.US" | "INCY.US" | "IQV.US" | "LH.US"
        | "MTD.US" | "PODD.US" | "RVTY.US" | "SOLV.US" | "STE.US" | "UHS.US" | "VTRS.US" => {
            Some("healthcare")
        }
        ...
        | "DECK.US" | "EBAY.US" | "ORLY.US" | "POOL.US" | "TSCO.US" | "KR.US" | "BBY.US"
        | "CAG.US" | "CCL.US" | "CHD.US" | "CLX.US" | "CPB.US" | "DRI.US" | "EL.US" | "EXPE.US"
        | "GPC.US" | "HAS.US" | "HRL.US" | "HST.US" | "KVUE.US" | "LEN.US" | "DHI.US"
        | "LII.US" | "MGM.US" | "MKC.US" | "MNST.US" | "NCLH.US" | "PHM.US" | "RL.US"
        | "SJM.US" | "SNA.US" | "TAP.US" | "TPR.US" | "TSN.US" | "ULTA.US" | "VFC.US"
        | "WBA.US" => Some("consumer"),
        // ── Energy ──
        "XOM.US" | "CVX.US" | "COP.US" | "SLB.US" | "EOG.US" | "MPC.US" | "PSX.US" | "VLO.US"
        | "OXY.US" | "HAL.US" | "DVN.US" | "FANG.US" | "KMI.US" | "WMB.US" | "OKE.US"
        | "LNG.US" | "ENPH.US" | "FSLR.US" | "TRGP.US" | "APA.US" | "BKR.US" | "CF.US"
        | "CTRA.US" | "EQT.US" | "EXE.US" => Some("energy"),
        // ── Industrial ──
        ...
        | "LDOS.US" | "ODFL.US" | "OTIS.US" | "PCAR.US" | "TT.US" | "AXON.US" | "BLDR.US"
        | "CHRW.US" | "CMI.US" | "DOV.US" | "EME.US" | "EXPD.US" | "FIX.US" | "GNRC.US"
        | "HII.US" | "HWM.US" | "IR.US" | "J.US" | "JBHT.US" | "JBL.US" | "JCI.US" | "NDSN.US"
        | "PH.US" | "PNR.US" | "PWR.US" | "ROP.US" | "ROL.US" | "SWK.US" | "TDG.US" | "TDY.US"
        | "TEL.US" | "TFX.US" | "TXT.US" | "URI.US" | "WAB.US" | "XYL.US" => Some("industrial"),
        // ── Utility ──
        "NEE.US" | "DUK.US" | "SO.US" | "D.US" | "AEP.US" | "SRE.US" | "EXC.US" | "XEL.US"
        | "PCG.US" | "ED.US" | "CEG.US" | "VST.US" | "CPRT.US" | "AEE.US" | "AES.US" | "ATO.US"
        | "AWK.US" | "CMS.US" | "CNP.US" | "DTE.US" | "EIX.US" | "ES.US" | "ETR.US" | "EVRG.US"
        | "FE.US" | "LNT.US" | "NI.US" | "NRG.US" | "PEG.US" | "PNW.US" | "PPL.US" | "WEC.US" => {
            Some("utility")
        }
        // ── Real Estate ──
        "PLD.US" | "AMT.US" | "CCI.US" | "EQIX.US" | "SPG.US" | "PSA.US" | "O.US" | "DLR.US"
        | "WELL.US" | "AVB.US" | "CBRE.US" | "EQR.US" | "IRM.US" | "SBAC.US" | "ARE.US"
        | "BXP.US" | "CPT.US" | "ESS.US" | "EXR.US" | "FRT.US" | "INVH.US" | "KIM.US"
        | "MAA.US" | "REG.US" | "UDR.US" | "VICI.US" => Some("real_estate"),
        // ── Materials ──
        "LIN.US" | "SHW.US" | "APD.US" | "ECL.US" | "FCX.US" | "NEM.US" | "NUE.US" | "DOW.US"
        | "DD.US" | "VMC.US" | "MLM.US" | "PKG.US" | "ALB.US" | "AVY.US" | "BALL.US" | "BG.US"
        | "CRH.US" | "CTVA.US" | "IP.US" | "MAS.US" | "MOS.US" | "PPG.US" | "STLD.US" | "SW.US"
        | "WRK.US" | "WY.US" | "ADM.US" | "AME.US" | "GLW.US" | "IFF.US" => Some("materials"),
        // ── Telecom / Media ──
        ...
        "AIZ.US" | "ALLE.US" | "AMCR.US" | "AMP.US" | "AOS.US" | "CTAS.US" | "NTAP.US"
        | "NVR.US" | "RHI.US" | "SATS.US" | "TROW.US" | "WAT.US" | "APH.US" | "FTV.US"
        | "MSI.US" => Some("industrial"),
