...
static EVENT_ATTRIBUTION: &[(MarketEventKind, EventDriverKind, EventPropagationScope)] = &[
    ...
    (
        ...
        EventDriverKind::CompanySpecific,
        EventPropagationScope::Local,
    ),
    (
    ...
    (
        MarketEventKind::BrokerSideFlip,
        EventDriverKind::CompanySpecific,
        EventPropagationScope::Local,
    ),
    (
    ...
    (
        ...
        EventDriverKind::SectorWide,
        EventPropagationScope::Sector,
    ),
    (
    ...
    (
        MarketEventKind::CatalystActivation,
        EventDriverKind::SectorWide,
        EventPropagationScope::Sector,
    ),
    ...
    (
        ...
        EventDriverKind::MacroWide,
        EventPropagationScope::Market,
    ),
    (
...
pub fn attribution_for_event_kind(
    kind: &MarketEventKind,
) -> Option<(EventDriverKind, EventPropagationScope)> {
    EVENT_ATTRIBUTION
        .iter()
        .find(|(k, _, _)| k == kind)
