...
pub fn compose_states(predicates: &[AtomicPredicate]) -> Vec<CompositeState> {
    ...
    let mut states = vec![
        ...
        composite_state(
            ...
            &scores,
            &[
                (AtomicPredicateKind::LiquidityImbalance, dec!(0.40)),
                (AtomicPredicateKind::ConsolidationBeforeBreakout, dec!(0.15)),
        ...
        composite_state(
            ...
            &scores,
            &[
                (AtomicPredicateKind::MeanReversionPressure, dec!(0.45)),
                (AtomicPredicateKind::RegimeStability, dec!(0.15)),
                (AtomicPredicateKind::PriceReasoningDivergence, dec!(0.25)),
                (AtomicPredicateKind::CounterevidencePresent, dec!(0.15)),
            ],
        ),
        composite_state(
