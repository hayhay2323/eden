...
pub use feedback::{
    apply_feedback_to_hypothesis, apply_learning_feedback, derive_learning_feedback,
    supplemental_horizon_learning_mode, HorizonLearningMode,
};
#[cfg(feature = "persistence")]
pub use feedback::{delta_from_case_resolution, profitable_but_late_bucket_deltas};
...
pub use types::{
    ConditionedLearningAdjustment, HorizonLearningAdjustment, LearningAdjustment,
    MechanismFactorAdjustment, OutcomeLearningContext, ReasoningLearningFeedback,
