...
use crate::external::polymarket::PolymarketPrior;
...
pub struct TickRecord {
    ...
    pub polymarket_priors: Vec<PolymarketPrior>,
...
impl TickRecord {
    pub fn capture(
        ...
        polymarket_priors: &[PolymarketPrior],
        ...
        TickRecord {
            ...
            polymarket_priors: polymarket_priors.to_vec(),
