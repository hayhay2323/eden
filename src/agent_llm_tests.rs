    ...
    use crate::agent::{
        ...
        AgentLensComponent, AgentRecommendation, AgentRecommendations, AgentSession,
        AgentSnapshot, AgentWakeState,
    };
    ...
    fn build_narration_emits_dominant_lenses_from_action_cards() {
        ...
        let recommendations = AgentRecommendations {
            ...
            decisions: vec![AgentDecision::Symbol(AgentRecommendation {
                ...
                governance_reason:
                    "severity=`high` forces human review before `enter` can execute".into(),
            })],
            items: vec![],
            knowledge_links: vec![],
        };
