...
use crate::ontology::reasoning::{Hypothesis, TacticalSetup};
...
mod tests {
    ...
    fn make_record(tick: u64) -> UsTickRecord {
        ...
        signals.insert(
            ...
            UsSymbolSignals {
                ...
                composite: dec!(0.3),
                composite_delta: dec!(0.03),
                composite_acceleration: dec!(0.01),
                capital_flow_direction: dec!(0.1),
                capital_flow_delta: dec!(0.02),
                flow_persistence: 2,
                flow_reversal: false,
    ...
    fn record_fields_accessible() {
        ...
        assert_eq!(sig.flow_persistence, 2);
    }
