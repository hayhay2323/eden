...
| [docs/api-surfaces.md](/Users/hayhay2323/Desktop/eden/docs/architecture/api-surfaces.md) | `aligned` | Documents `agent/*` as compatibility only. |
...
- `scripts/ops/run_codex_analyst.py`
...
1. `scripts/ops/run_codex_analyst.py`
