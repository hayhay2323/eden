...
- `GET /api/us/live`
- `GET /api/us/lineage`
- `GET /api/us/lineage/history`
- `GET /api/us/lineage/rows`
- `GET /api/us/causal/flips`
- `GET /api/us/causal/timeline/:symbol`
- `GET /api/polymarket`
...
Run the US engine through the integrated root command:

```bash
cargo run --bin eden -- us
```
